...
if (!class_exists('\\BootstrapBasic4\\BootstrapBasic4')) {
    ...
    class BootstrapBasic4
    {
        ...
        {
            global $content_width, $ocws_cyclops_sidebar_left_size, $ocws_cyclops_sidebar_right_size;
            ...
            $content_width = apply_filters('bootstrap_basic4_content_width', $content_width, $ocws_cyclops_sidebar_left_size, $ocws_cyclops_sidebar_right_size);
        }// detectContentWidth
        ...
        {
            wp_enqueue_style('cyclops-wp-main', get_stylesheet_uri(), array(), '1.2.1');
            ...
            wp_enqueue_style('cyclops-font-awesome5', get_template_directory_uri() . '/assets/fontawesome/css/all.min.css', array(), '5.6.3');
            wp_enqueue_style('cyclops-main', get_template_directory_uri() . '/assets/css/main.css', array(), '1.2.1');
            ...
            wp_enqueue_script('cyclops-main', get_template_directory_uri() . '/assets/js/main.js', array('jquery'), '1.2.1', true);
        ...
        {
            wp_register_style('bootstrap4', get_template_directory_uri() . '/assets/css/bootstrap.css', array(), '4.2.1');
        ...
        public function registerSidebars()
        {
            ...
            register_sidebar(array(
                'name'          => __('Navigation bar right', 'cyclops'),
                'id'            => 'navbar-right',
                'before_widget' => '',
                'after_widget'  => '',
                'before_title'  => '',
        ...
        public function themeSetup()
        {
            ...
            load_theme_textdomain('cyclops', get_template_directory() . '/languages');
            ...
            register_nav_menus(array(
                'primary' => __('Primary Menu', 'cyclops'),
            ));
