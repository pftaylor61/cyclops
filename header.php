            ...
            <header class="page-header page-header-sitebrand-topbar">
                <div class="row row-with-vspace site-branding">
                    <div class="col-md-6 site-title">
						...
						if( !empty( $headerImg ) ) { ?>
							<img src="<?php header_image(); ?>" height="<?php echo get_custom_header()->height; ?>" width="<?php echo get_custom_header()->width; ?>" alt="<?php echo get_custom_header()->alttext; ?>" />
						<?php } ?>
                ...
                <div class="row main-navigation">
                    <div class="col-md-12">
                        <nav class="navbar navbar-expand-lg navbar-light bg-light">
                            <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#cyclops-topnavbar" aria-controls="cyclops-topnavbar" aria-expanded="false" aria-label="<?php esc_attr_e('Toggle navigation', 'cyclops'); ?>">
                                <span class="navbar-toggler-icon"></span>
                            </button>
                            <div id="cyclops-topnavbar" class="collapse navbar-collapse">
                                <?php 
                                wp_nav_menu(
                                    array(
                                        'depth' => '2',
